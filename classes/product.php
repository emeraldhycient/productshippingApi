...
public static function updateShipment($sendername,$senderemail,$senderphone,$senderaddress,$receivername,
$receiveremail,$receiverphone,$receiveraddress,$tracking,$weigth,$qty,$method,$bookingdate,$deliverydate,
$payment,$statuz,$description,$comment
){
...
$sql = "UPDATE shipmentdetails SET sendername='$sendername',senderemail='$senderemail',senderphone='$senderphone',senderaddress='$senderaddress', 
receivername='$receivername',receiveremail='$receiveremail',receiverphone='$receiverphone',receiveraddress='$receiveraddress',tracking='$tracking',
weigth='$weigth',qty='$qty',method='$method',bookingdate='$bookingdate',deliverydate='$deliverydate',payment='$payment',statuz='$statuz',
descriptions='$description',comment='$comment' WHERE tracking='$tracking'
";
    ...
    if($query){
        ...
        self::sendmail($senderemail,$sendername,"shiplive shipment details updated",$table);
        self::sendmail($receiveremail,$receivername,"shiplive product delivery details updated",$table);
